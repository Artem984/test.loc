...
?><?$APPLICATION->IncludeComponent("bitrix:iblock.element.add", ".default", array(
	...
	"PROPERTY_CODES" => array(
		...
		2 => "IBLOCK_SECTION",
		3 => "DETAIL_TEXT",
		4 => "96",5 => "97",6 => "98",7 => "99",8 => "100",9 => "101",10 => "102",11 => "103",12 => "104",13 => "105",14 => "106",15 => "107",16 => "108",
	),
	"PROPERTY_CODES_REQUIRED" => array(
		0 => "NAME",
		1 => "DATE_ACTIVE_TO",
		2 => "IBLOCK_SECTION",
		3 => "96", 4 => "97",  5 => "98",  6 => "108", 
	),
	"GROUPS" => array(
		0 => "1",
		1 => "5",
	...
	"SEF_MODE" => "N",
	"SEF_FOLDER" => "/detalfishjob/vacancy/my/",
	"AJAX_MODE" => "N",
